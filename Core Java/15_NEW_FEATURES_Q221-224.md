...
- Language-level generics and syntactic sugar improvements

**Interviewer Expectation:**
Should list main features and their impact on code clarity and safety.
...
**Key Theoretical Concepts:**
- Standard library and tooling evolution

**Interviewer Expectation:**
Should know Java 6 had smaller language changes but ecosystem improvements.
...
**Key Theoretical Concepts:**
- Resource management improvements and concurrency additions

**Interviewer Expectation:**
Should mention try-with-resources and multi-catch as important ergonomics.
...
**Key Theoretical Concepts:**
- Functional programming constructs and a richer concurrency toolkit

**Interviewer Expectation:**
A 2-year developer should be comfortable with lambdas and streams and know `Optional` use-cases.

**Red Flags:**
- Not knowing basic Java 8 features like lambdas/streams

**Depth Expected:** Intermediate

---

End of NEW FEATURES (Questions 221-224)

...
5. Scenario: You have a form that is reused across multiple modules. How would you structure it for maintainability and reusability?
...
14. Scenario: Two MFEs need to communicate (for example a shopping cart MFE and a user profile MFE). How would you implement cross-MFE communication?
...
17. Scenario: A feature team wants to deploy their MFE independently without affecting the main app. How would you achieve this in Angular?
